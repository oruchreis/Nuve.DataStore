...
namespace Nuve.DataStore
{
    ...
    public interface IDataStoreProvider
    {
        ...
        void Lock(string lockKey, TimeSpan waitTimeout, Action action, TimeSpan slidingExpire, bool skipWhenTimeout = true, bool throwWhenTimeout = false, string? fencingKey = null, TimeSpan? fencingExpire = null);
        /// <summary>
        ...
        DataStoreLock? AcquireLock(string lockKey, CancellationToken waitCancelToken, TimeSpan slidingExpire, bool throwWhenTimeout, string? fencingKey = null, TimeSpan? fencingExpire = null);
        /// <summary>
        ...
        Task LockAsync(string lockKey, TimeSpan waitTimeout, Func<Task> action, TimeSpan slidingExpire, bool skipWhenTimeout = true, bool throwWhenTimeout = false, string? fencingKey = null, TimeSpan? fencingExpire = null);
        /// <summary>
        ...
        Task<DataStoreLock?> AcquireLockAsync(string lockKey, CancellationToken waitCancelToken, TimeSpan slidingExpire, bool throwWhenTimeout, string? fencingKey = null, TimeSpan? fencingExpire = null);
    }
}
